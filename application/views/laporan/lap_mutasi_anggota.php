...
function tampilkan_laporan() {
    ...
    if (validasi) {
        ...
        $.ajax({
            url: situs + "laporan/get_mutasi_anggota_html",
            data: dataForm,
            beforeSend: function() {
...
function xls_laporan() {
    ...
    if (validasi) {
        ...
        window.open(situs + "laporan/get_mutasi_anggota_xls?" + dataForm);
    }
}
...
function pdf_laporan() {
    ...
    if (validasi) {
        ...
        window.open(situs + "laporan/get_mutasi_anggota_pdf?" + dataForm);
    }
}
</script>