...
class Anggota_per_perusahaan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['judul_menu'] = "Laporan Anggota Per Perusahaan";
        $data['bulan']      = $bulan;

        $this->template->view("laporan/lap_anggota_per_prsh", $data);
    }
    ...
    public function tampilkan()
    {
        ...
        if ($data_req) {
            ...
            $data_anggota = $this->laporan_model->get_ang_per_prsh($data_req['tahun'], $data_req['bulan'], $data_req['kd_prsh']);
    ...
    public function excel()
    {
        ...
        $file = "lap_ang_per_perusahaan_" . $data_req['kd_prsh'] . "_" . $data_req['bulan'] . "-" . $data_req['tahun'] . ".xls";
